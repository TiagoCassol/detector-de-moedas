...
# Inicializando o formato de dados de entrada para o modelo
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

classes = ["1 real", "25 cent", "50 cent"]

def preProcess(img):
    # Aplicando desfoque para reduzir ruídos
    imgPre = cv2.GaussianBlur(img, (15, 15), 3)
   
    # Detectando bordas na imagem com o algoritmo Canny
    imgPre = cv2.Canny(imgPre, 2, 140)# voce pode alterar estes valores dependendo do ambiente
...
while True:
    ...
    # Encontrando os contornos da imagem pré-processada
    ...
    for cnt in countors:
        ...
        if area > 2000:
            ...
            classe, confianca = DetectarMoeda(recorte)
